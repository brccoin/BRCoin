...
unlocked to sign the Brcoin-Qt.app bundle.
...
allowing somebody to distribute a Brcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the brcoin-qt.exe file inside the installer had not been tampered with.
